...
namespace Cinema_Website.Data.Migrations
{
    ...
    [Migration("20220612230920_editingRelationship")]
    partial class editingRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cinema_Website.Models.AddingCategory", b =>
                {
                    b.Property<int>("AddingCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Cinema_Website.Models.Customer", b =>
                {
                    ...
                    b.Property<int?>("ViewingMovieId")
                        .HasColumnType("int");

                    b.HasKey("CustomerId");

                    b.HasIndex("ViewingMovieId");
            ...
            modelBuilder.Entity("Cinema_Website.Models.ViewingMovie", b =>
                {
                    ...
                    b.HasKey("ViewingMovieId");

                    b.ToTable("ViewingMovie");
                });
            ...
            modelBuilder.Entity("Cinema_Website.Models.Category", b =>
                {
                    b.HasOne("Cinema_Website.Models.AddingCategory", "AddingCategory")
                        .WithMany("Categories")
                        .HasForeignKey("AddingCategoryId");

                    b.Navigation("AddingCategory");
                });

            modelBuilder.Entity("Cinema_Website.Models.Customer", b =>
                {
                    b.HasOne("Cinema_Website.Models.ViewingMovie", "ViewingMovie")
                        .WithMany("Customers")
                        .HasForeignKey("ViewingMovieId");
            ...
            modelBuilder.Entity("Cinema_Website.Models.Movie", b =>
                {
                    ...
                    b.HasOne("Cinema_Website.Models.Admin", "Admin")
                        .WithMany("Movies")
